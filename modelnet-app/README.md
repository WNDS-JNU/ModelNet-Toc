...
ModelNet organizes your agents into 7×24 operation.
...
Whether for users or professional developers, ModelNet will be your AI Agent playground. Please be aware that ModelNet is currently under active development, and feedback is welcome for any [issues][issues-link] encountered.

| [![](https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1065874&theme=light&t=1769347414733)](https://www.producthunt.com/products/lobehub?launch=lobehub-2&embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-lobehub) | We are live on Product Hunt! We are thrilled to bring ModelNet to the world. If you believe in a future where humans and agents co-evolve, please support our journey. |
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![][discord-shield-badge]][discord-link]                                                                                                                                                                                                                          | Join our Discord community! This is where you can connect with developers and other enthusiastic users of ModelNet.                                                    |
...
**ModelNet changes everything.**

ModelNet is a work-and-lifestyle space to find, build, and collaborate with agent teammates that grow with you. In ModelNet, we treat **Agents as the unit of work**, providing an infrastructure where humans and agents co-evolve.
...
ModelNet introduces **Agent Groups**, allowing you to work with agents like real teammates. The system assembles the right agents for the task, enabling parallel collaboration and iterative improvement.
...
The best AI is one that understands you deeply. ModelNet features **Personal Memory** that builds a clear understanding of your needs.
...
> ✨ more features will be added when ModelNet evolve.
...
ModelNet provides Self-Hosted Version with Vercel, Alibaba Cloud, and [Docker Image][docker-release-link]. This allows you to deploy your own chatbot within a few minutes without any prior knowledge.

> \[!TIP]
>
> Learn more about [📘 Build your own ModelNet][docs-self-hosting] by checking it out.
...
We provide a Docker image for deploying the ModelNet service on your own private device. Use the following command to start the ModelNet service:
...
2. init the ModelNet infrastructure

```fish
bash <(curl -fsSL https://lobe.li/setup.sh)
```

3. Start the ModelNet service
...
An API Key is required to chat with LLMs in ModelNet. This section uses the OpenAI model provider as an example to briefly introduce how to obtain an API Key.
...
- Fill this API Key into the ModelNet API Key configuration and you are ready to go.
...
| [@lobehub/lint][lobe-lint-link]   | [lobehub/lobe-lint][lobe-lint-github]   | Configurations for ESlint, Stylelint, Commitlint, Prettier, Remark, and Semantic Release for ModelNet. | [![][lobe-lint-shield]][lobe-lint-link]   |
...
Plugins provide a means to extend the [Function Calling][docs-function-call] capabilities of ModelNet. They can be used to introduce new function calls and even new ways to render message results. If you are interested in plugin development, please refer to our [📘 Plugin Development Guide][docs-plugin-dev] in the Wiki.

- [lobe-chat-plugins][lobe-chat-plugins]: This is the plugin index for ModelNet. It accesses index.json from this repository to display a list of available plugins for ModelNet to the user.
- [chat-plugin-template][chat-plugin-template]: This is the plugin template for ModelNet plugin development.
- [@lobehub/chat-plugin-sdk][chat-plugin-sdk]: The ModelNet Plugin SDK assists you in creating exceptional chat plugins for ModelNet.
- [@lobehub/chat-plugins-gateway][chat-plugins-gateway]: The ModelNet Plugins Gateway is a backend service that provides a gateway for ModelNet plugins. We deploy this service using Vercel. The primary API POST /api/v1/runner is deployed as an Edge Function.
...
>
> Help us make ModelNet better. Welcome to provide product design feedback, user experience discussions directly to us.
>
...
Copyright © 2026 [ModelNet][profile-link]. <br />
This project is [ModelNet Community License](./LICENSE) licensed.
...
[deploy-on-alibaba-cloud-link]: https://computenest.console.aliyun.com/service/instance/create/default?type=user&ServiceName=ModelNet%E7%A4%BE%E5%8C%BA%E7%89%88
