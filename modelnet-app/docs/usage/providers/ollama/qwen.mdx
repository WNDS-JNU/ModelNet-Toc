---
title: Using the Local Qwen Model in ModelNet
description: >-
  Easily chat with the locally deployed Qwen model through ModelNet's integration
  with Ollama. Learn how to install and select the Qwen model.
tags:
  - Qwen
  - Qwen Model
  - ModelNet Integration
  - Ollama
  - Local Deployment
---
...
<Image alt={'Using Qwen in ModelNet'} cover src={'/blog/assets17870709/b4a01219-e7b1-48a0-888c-f0271b18e3a6.webp'} />
...
Now, thanks to ModelNet’s integration with [Ollama](https://ollama.com/), you can easily use the Qwen model locally within ModelNet.

This guide will walk you through how to use the locally deployed Qwen model in ModelNet:
...
You’re now ready to start chatting with the local Qwen model in ModelNet.
