---
title: Using the Minimax API Key in ModelNet
description: >-
  Learn how to configure and use the MiniMax AI model in ModelNet. This guide
...
# Using Minimax in ModelNet

<Image alt={'Using Minimax in ModelNet'} cover src={'/blog/assets34400653/703f170b-c03b-4c71-b57d-c2357596bdfb.webp'} />
...
This guide will walk you through how to use MiniMax in ModelNet:
...
<Steps>
  ...
  ### Step 2: Configure MiniMax in ModelNet
...
You're all set! You can now start chatting with models powered by MiniMax in ModelNet.
