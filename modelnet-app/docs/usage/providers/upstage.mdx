---
title: Using Upstage in ModelNet
description: >-
  Learn how to configure and use Upstage's API Key in ModelNet to start
...
This guide will walk you through how to use Upstage within ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure Upstage in ModelNet
...
And that’s it! You’re now ready to use Upstage’s models for conversations in ModelNet.
