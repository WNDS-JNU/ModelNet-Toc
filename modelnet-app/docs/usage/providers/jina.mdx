---
title: Using Jina AI API Key in ModelNet
description: >-
  Learn how to configure and use Jina AI models in ModelNet, obtain your API key,
  and start chatting.
tags:
  - ModelNet
  - Jina AI
...
# Using Jina AI in ModelNet

<Image alt={'Using Jina AI in ModelNet'} cover src={'/blog/assetsc6ff27b7134f280727e1fd7ff83ed2fa.webp'} />
...
This guide will walk you through how to use Jina AI in ModelNet:
...
<Steps>
  ...
  ### Step 2: Configure Jina AI in ModelNet
...
And that’s it! You’re now ready to start chatting with models powered by Jina AI in ModelNet.
