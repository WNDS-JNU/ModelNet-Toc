---
title: Using 360 Zhinao in ModelNet
description: >-
  Learn how to configure and use the 360 Zhinao API Key in ModelNet to start
...
This guide will walk you through how to use 360 Zhinao within ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure 360 Zhinao in ModelNet
...
That's it! You're now ready to use 360 Zhinao's models for conversations in ModelNet.
