---
title: Using Azure AI API Key in ModelNet
description: >-
  Learn how to configure and use Azure AI models in ModelNet, obtain your API
...
# Using Azure AI in ModelNet

<Image alt={'Using Azure AI in ModelNet'} cover src={'/blog/assets29de82efbe7657a8b9ba7daf0904585d.webp'} />
...
This guide will walk you through how to integrate Azure AI models into ModelNet:
...
<Steps>
  ...
  ### Step 3: Configure Azure AI in ModelNet
...
That's it! You're now ready to use Azure AI models for conversations in ModelNet.
