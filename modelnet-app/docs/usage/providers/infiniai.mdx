---
title: Using Infini-AI in ModelNet
description: >-
  Learn how to configure and use Infini-AI's API Key in ModelNet to enable
...
This guide will walk you through the steps to quickly integrate Infini-AI's capabilities into ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure the Model Service in ModelNet

  - Open ModelNet and go to the "Settings" page
