---
title: Using InternLM in ModelNet
description: >-
  Learn how to configure and use your InternLM API Key in ModelNet to start
...
This guide will walk you through how to use InternLM within ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure InternLM in ModelNet
...
You’re all set! You can now start using InternLM-powered models in ModelNet for conversations and interactions.
