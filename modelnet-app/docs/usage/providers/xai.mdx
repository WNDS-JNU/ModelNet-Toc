---
title: Using xAI in ModelNet
description: >-
  Learn how to configure and use xAI's API Key in ModelNet to start chatting and
  interacting.
tags:
  - ModelNet
  - xAI
...
This guide will walk you through how to use xAI within ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure xAI in ModelNet
...
You’re now ready to start using xAI-powered models in ModelNet for conversations and interactions.
