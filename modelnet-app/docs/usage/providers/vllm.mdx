---
title: Using vLLM API Key in ModelNet
description: >-
  Learn how to configure and use vLLM language models in ModelNet, obtain an API
...
# Using vLLM in ModelNet

<Image alt={'Using vLLM in ModelNet'} cover src={'/blog/assets1049abec5850cebf8ce12cd50199b9c5.webp'} />
...
This guide will walk you through how to use vLLM in ModelNet:
...
<Steps>
  ...
  ### Step 4: Configure vLLM in ModelNet

  - Open the `App Settings` panel in ModelNet
...
You're now ready to use vLLM-powered models in ModelNet for conversations.
