---
title: Using AI21 Labs in ModelNet
description: >-
  Learn how to configure and use your AI21 Labs API Key in ModelNet to start
...
This guide will walk you through how to use AI21 Labs within ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure AI21 Labs in ModelNet
...
And that’s it! You’re now ready to use AI21 Labs models for conversations in ModelNet.
