---
title: 在 ModelNet 中使用无问芯穹
description: 学习如何在 ModelNet 中配置和使用无问芯穹的 API Key，实现 AI 对话交互。
tags:
  - ModelNet
  - 无问芯穹
  - API密钥
...
本文将指导你如何在 ModelNet 中快速接入无问芯穹的 AI 能力。
...
<Steps>
  ...
  ### 步骤二：配置 ModelNet 模型服务

  - 打开 ModelNet 进入「设置」界面
