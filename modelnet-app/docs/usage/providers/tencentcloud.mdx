---
title: Using Tencent Cloud API Key in ModelNet
description: >-
  Learn how to configure and use Tencent Cloud AI models in ModelNet, obtain your
...
# Using Tencent Cloud in ModelNet

<Image alt={'Using Tencent Cloud in ModelNet'} cover src={'/blog/assetsf625540e8340bafe69ccbb89ad75707a.webp'} />
...
This guide will walk you through how to integrate Tencent Cloud's AI models into ModelNet:
...
<Steps>
  ...
  ### Step 2: Configure Tencent Cloud in ModelNet

  - Open ModelNet and go to App Settings > AI Service Providers.
...
That's it! You’re now ready to use Tencent Cloud’s AI models in ModelNet for conversations.
