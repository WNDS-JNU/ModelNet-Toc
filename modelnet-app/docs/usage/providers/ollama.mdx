---
title: Using Ollama in ModelNet
description: >-
  Learn how to use Ollama in ModelNet to run large language models locally and
...
# Using Ollama in ModelNet

<Image alt={'Using Ollama in ModelNet'} borderless cover src={'/blog/assets17870709/f579b39b-e771-402c-a1d1-620e57a10c75.webp'} />

Ollama is a powerful framework for running large language models (LLMs) locally. It supports a variety of models, including Llama 2, Mistral, and more. ModelNet now integrates seamlessly with Ollama, allowing you to leverage these models directly within your chat interface.

This guide will walk you through how to use Ollama in ModelNet:

<Video alt={'Full demo of using Ollama in ModelNet'} height={580} src="/blog/assets28616219/c32b56db-c6a1-4876-9bc3-acbd37ec0c0c.mp4" />
...
<Steps>
  ...
  ### Chat with Local LLMs in ModelNet

  You can now start chatting with local LLMs in ModelNet.

  <Image alt="Chatting with llama3 in ModelNet" height="573" src="/blog/assets28616219/7f9a9a9f-fd91-4f59-aac9-3f26c6d49a1e.webp" />
</Steps>
...
### Install via ModelNet

ModelNet comes pre-configured with popular LLMs like llama3, Gemma, and Mistral. When you select a model for the first time, ModelNet will prompt you to download it.

<Image alt="ModelNet prompts to install Ollama model" height="460" src="/blog/assets28616219/4e81decc-776c-43b8-9a54-dfb43e9f601a.webp" />
...
You can configure Ollama settings in ModelNet under `Settings` -> `AI Providers`. Here, you can set the proxy, model name, and more.

<Image alt={'Ollama provider settings'} height={274} src={'/blog/assets28616219/54b3696b-5b13-4761-8c1b-1e664867b2dd.webp'} />

<Callout type={'info'}>
  To learn how to deploy ModelNet with Ollama integration, visit [Integrating with Ollama](/en/docs/self-hosting/examples/ollama).
</Callout>
