---
title: 在 ModelNet 中使用 Nvidia NIM API Key
description: 学习如何在 ModelNet 中配置和使用 Nvidia NIM AI 模型，获取 API 密钥并开始对话。
tags:
  - ModelNet
  - Nvidia NIM
  - API密钥
...
# 在 ModelNet 中使用 Nvidia NIM

<Image alt={'在 ModelNet 中使用 Nvidia NIM'} cover src={'/blog/assetsd8927338578c426b833e5cb57e0b57ec.webp'} />
...
本文档将指导你如何在 ModelNet 中接入并使用 Nvidia NIM 提供的 AI 模型:
...
至此你已经可以在 ModelNet 中使用 Nvidia NIM 提供的模型进行对话了。
