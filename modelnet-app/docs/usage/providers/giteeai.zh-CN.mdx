---
title: 在 ModelNet 中使用 Gitee AI
description: 学习如何在 ModelNet 中配置和使用 Gitee AI 的 API Key，以便开始对话和交互。
tags:
  - ModelNet
  - Gitee AI
  - API密钥
...
本文将指导你如何在 ModelNet 中使用 Gitee AI。
...
至此你已经可以在 ModelNet 中使用 Gitee AI 提供的模型进行对话了。
