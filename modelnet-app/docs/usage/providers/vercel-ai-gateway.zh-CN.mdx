---
title: 在 ModelNet 中使用 Vercel AI Gateway
description: 了解如何在 ModelNet 中集成和使用 Vercel AI Gateway 的统一 API
tags:
  - ModelNet
  - Vercel AI Gateway
  - API 密钥
...
<Steps>
  ...
  ### 第二步：在 ModelNet 中配置 Vercel AI Gateway
...
至此，您可以在 ModelNet 中使用 Vercel AI Gateway 提供的模型开始聊天了。
...
- **DeepSeek**: `deepseek/deepseek-v3`、`deepseek/deepseek-r1` 等
- 以及更多...
