---
title: 在 ModelNet 中使用 PPIO 派欧云 API Key
description: >-
  学习如何将 PPIO 派欧云的 LLM API 集成到 ModelNet 中。跟随以下步骤注册 PPIO 账号、创建 API Key、并在 ModelNet
  中进行设置。
tags:
  - PPIO
  - PPInfra
...
# 在 ModelNet 中使用 PPIO 派欧云

<Image alt={'在 ModelNet 中使用 PPIO'} cover src={'/blog/assets06d4e543cbaca9a2762923a23b2cae67.webp'} />
...
<Steps>
  ...
  ### 步骤三：在 ModelNet 中配置 PPIO 派欧云

  - 访问 ModelNet 的 `设置` 界面
  - 在 `AI 服务商` 下找到 `PPIO` 的设置项
  - 打开 PPIO 并填入获得的 API 密钥

  <Image alt={'在 ModelNet 中输入 PPIO API 密钥'} inStep src={'/blog/assetsbfe7d519c29884b6699e89866e1db7e2.webp'} />
...
至此你已经可以在 ModelNet 中使用 PPIO 派欧云提供的模型进行对话了。
