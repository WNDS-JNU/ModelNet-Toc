---
title: Using OpenRouter API Key in ModelNet
description: >-
  Learn how to register, create an API key, add credit, and configure OpenRouter
  in ModelNet to start using a variety of powerful large language model APIs.
tags:
  - OpenRouter
  - API Key
  - Web UI
...
# Using OpenRouter in ModelNet

<Image alt={'Using OpenRouter in ModelNet'} cover src={'/blog/assets34400653/40520a43-ac03-4954-8a4d-282fbb946066.webp'} />
...
This guide will walk you through how to use OpenRouter in ModelNet:
...
<Steps>
  ...
  - In the pop-up dialog, give your API key a name, such as "ModelNet Key".
  ...
  ### Step 4: Configure OpenRouter in ModelNet

  - Open the `Settings` panel in ModelNet.
  - Under `AI Providers`, find the `OpenRouter` section.
  - Enable OpenRouter and paste in your API key.

  <Image alt={'Configure OpenRouter in ModelNet'} height={518} inStep src={'/blog/assets34400653/5c3898ab-23d7-44c2-bbd9-b255e25e400c.webp'} />
...
You’re now ready to start using OpenRouter’s models in ModelNet for conversations.
