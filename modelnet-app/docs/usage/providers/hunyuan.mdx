---
title: Using Tencent Hunyuan in ModelNet
description: >-
  Learn how to configure and use Tencent Hunyuan's API Key in ModelNet to start
...
# Using Tencent Hunyuan in ModelNet
...
This guide will walk you through how to use Tencent Hunyuan in ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure Tencent Hunyuan in ModelNet
...
And that’s it! You’re now ready to use Tencent Hunyuan’s models for conversations in ModelNet.
