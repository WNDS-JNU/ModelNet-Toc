---
title: Using Wenxin Qianfan in ModelNet
description: >-
  Learn how to configure and use the Wenxin Qianfan API Key in ModelNet to start
...
# Using Wenxin Qianfan in ModelNet
...
This guide will walk you through how to use Wenxin Qianfan in ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure Wenxin Qianfan in ModelNet
...
Now you're all set to start using Wenxin Qianfan models for conversations in ModelNet.
