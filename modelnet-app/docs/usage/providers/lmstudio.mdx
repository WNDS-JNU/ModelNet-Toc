---
title: Using LM Studio in ModelNet
description: >-
...
# Using LM Studio in ModelNet

<Image alt={'Using LM Studio in ModelNet'} cover src={'/blog/assets28749075f0c4d62c1642694a4ed9ec08.webp'} />
...
This guide will walk you through how to use LM Studio within ModelNet:
...
<Steps>
  ...
  ### Step 5: Connect LM Studio to ModelNet

  - Go to the `App Settings` in ModelNet and open the `AI Service Providers` section
...
And that’s it! You’re now ready to use models running in LM Studio directly within ModelNet.
