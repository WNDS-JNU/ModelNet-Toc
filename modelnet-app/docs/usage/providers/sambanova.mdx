---
title: Using the SambaNova API Key in ModelNet
description: >-
  Learn how to configure and use SambaNova models in ModelNet, obtain your API
...
# Using SambaNova in ModelNet

<Image alt={'Using SambaNova in ModelNet'} cover src={'/blog/assetsd9e6fe2197270f0f774accd6abcf4019.webp'} />
...
This guide will walk you through how to use SambaNova in ModelNet:
...
<Steps>
  ...
  ### Step 2: Configure SambaNova in ModelNet

  - Go to the `App Settings` section in ModelNet
...
You're now ready to start chatting with models powered by SambaNova in ModelNet.
