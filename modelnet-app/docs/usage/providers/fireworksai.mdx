---
title: Using Fireworks AI in ModelNet
description: >-
  Learn how to configure and use Fireworks AI's API Key in ModelNet to start
...
# Using Fireworks AI in ModelNet
...
This guide will walk you through how to use Fireworks AI within ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure Fireworks AI in ModelNet
...
And that’s it! You’re now ready to start using Fireworks AI models in ModelNet for conversations and interactions.
