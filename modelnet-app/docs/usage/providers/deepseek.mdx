---
title: Using DeepSeek API Key in ModelNet
description: >-
  Learn how to configure and use the DeepSeek language model in ModelNet, obtain
...
# Using DeepSeek in ModelNet

<Image alt={'Using DeepSeek in ModelNet'} cover src={'/blog/assets34400653/b4d12904-9d5d-46de-bd66-901eeb9c8e52.webp'} />
...
This guide will walk you through how to use DeepSeek in ModelNet:
...
<Steps>
  ...
  ### Step 2: Configure DeepSeek in ModelNet

  - Go to the `App Settings` page in ModelNet
  - Under `AI Providers`, find the `DeepSeek` configuration section

  <Image alt={'Enter DeepSeek API Key in ModelNet'} inStep src={'/blog/assets93da89c4892a80e2e5a6caa49d80af5f.webp'} />
...
And that’s it! You’re now ready to start chatting with DeepSeek-powered models in ModelNet.
