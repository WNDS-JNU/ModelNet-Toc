---
title: Using SenseTime SenseNova in ModelNet
description: >-
  Learn how to configure and use your SenseTime SenseNova API Key in ModelNet to
...
# Using SenseTime SenseNova in ModelNet
...
This guide will walk you through how to use SenseNova within ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure SenseNova in ModelNet
...
And that’s it! You’re now ready to use SenseTime SenseNova models in ModelNet for intelligent conversations.
