---
title: Using Cloudflare Workers AI in ModelNet
description: >-
  Learn how to configure and use the Cloudflare Workers AI API Key in ModelNet to
...
# Using Cloudflare Workers AI in ModelNet
...
This guide will walk you through how to use Cloudflare Workers AI in ModelNet:
...
<Steps>
  ...
  ### Step 2: Configure Cloudflare Workers AI in ModelNet
...
You’re all set! You can now start using Cloudflare Workers AI models for conversations in ModelNet.
