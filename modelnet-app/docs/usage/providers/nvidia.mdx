---
title: Using Nvidia NIM API Key in ModelNet
description: >-
  Learn how to configure and use Nvidia NIM AI models in ModelNet, obtain your
...
# Using Nvidia NIM in ModelNet

<Image alt={'Using Nvidia NIM in ModelNet'} cover src={'/blog/assetsd8927338578c426b833e5cb57e0b57ec.webp'} />
...
This guide will walk you through how to integrate and use AI models provided by Nvidia NIM in ModelNet:
...
<Steps>
  ...
  ### Step 2: Configure Nvidia NIM in ModelNet

  - Go to the `App Settings` section in ModelNet and navigate to `AI Service Providers`.
...
That’s it! You’re now ready to use Nvidia NIM-powered models in ModelNet for your conversations.
