---
title: Using Novita AI API Key in ModelNet
description: >-
  Learn how to integrate Novita AI's large language model API into ModelNet.
  Follow the steps to register a Novita AI account, create an API key, add
  credits, and configure it in ModelNet. Start chatting with a variety of AI
  models.
tags:
  - Novita AI
  - Llama3
...
# Using Novita AI in ModelNet

<Image alt={'Using Novita AI in ModelNet'} cover src={'/blog/assets85af5a2a51b851fe125055d374cc8263.webp'} />
...
This guide will walk you through how to use Novita AI in ModelNet:
...
<Steps>
  ...
  ### Step 3: Configure Novita AI in ModelNet
  ...
  <Image alt={'Enter Novita AI API Key in ModelNet'} inStep src={'/blog/assets05d786345e99f92d11baae5667a04a62.webp'} />
...
That’s it! You’re now ready to chat with Novita AI models directly in ModelNet.
