---
title: Using Tongyi Qianwen API Key in ModelNet
description: >-
  Learn how to configure and use Alibaba Cloud's Tongyi Qianwen model in
  ModelNet, offering powerful natural language understanding and generation
  capabilities.
tags:
  - ModelNet
  - Tongyi Qianwen
...
# Using Tongyi Qianwen in ModelNet

<Image alt={'Using Tongyi Qianwen in ModelNet'} cover src={'/blog/assets34400653/4e057b43-1e3e-4e96-a948-7cdbff303dcb.webp'} />
...
This guide will walk you through how to use Tongyi Qianwen in ModelNet:
...
<Steps>
  ...
  ### Step 3: Configure Tongyi Qianwen in ModelNet
...
You’re all set! You can now start using Tongyi Qianwen’s models in ModelNet for intelligent conversations.
