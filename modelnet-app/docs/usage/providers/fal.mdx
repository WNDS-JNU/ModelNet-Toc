---
title: Using Fal API Key in ModelNet
description: >-
  Learn how to configure and use the Fal API Key in ModelNet to generate
...
# Using Fal in ModelNet

<Image alt={'Using Fal in ModelNet'} cover src={'https://hub-apac-1.lobeobjects.space/docs/f253e749baaa2ccac498014178f93091.png'} />

[Fal.ai](https://fal.ai/) is a high-performance inference platform specializing in AI media generation. It offers state-of-the-art image and video generation models such as FLUX, Kling, and HiDream. This guide will walk you through how to use Fal within ModelNet:
...
'https://hub-apac-1.lobeobjects.space/docs/499a447e98dcc79407d56495d0305e2a.png'
  ...
  ### Step 2: Configure Fal in ModelNet

  - Navigate to the `Settings` page in ModelNet;
...
And that’s it! You’re now ready to create stunning visual content in ModelNet using Fal’s advanced image and video generation models.
