---
title: Using Gitee AI in ModelNet
description: >-
  Learn how to configure and use Gitee AI's API Key in ModelNet to start chatting
  and interacting.
tags:
  - ModelNet
  - Gitee AI
...
This guide will walk you through how to use Gitee AI within ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure Gitee AI in ModelNet
...
And that’s it! You’re now ready to use Gitee AI models for conversations in ModelNet.
