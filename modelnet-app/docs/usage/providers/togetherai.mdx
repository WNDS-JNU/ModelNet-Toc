---
title: Using the Together AI API Key in ModelNet
description: >-
  Learn how to configure and use the Together AI API key in ModelNet to start
...
# Using Together AI in ModelNet

<Image alt={'Using Together AI in ModelNet'} cover src={'/blog/assets34400653/28e025dd-367b-4add-85b6-499f4aacda61.webp'} />
...
This guide will walk you through how to use Together AI in ModelNet:
...
<Steps>
  ...
  ### Step 2: Configure Together AI in ModelNet

  - Go to the Settings page in ModelNet
  - Under the AI Providers section, find the settings for together.ai

  <Image alt={'Enter your Together AI API key in ModelNet'} inStep src={'/blog/assets34400653/0cc6c9b8-4688-472b-a80f-f84c5ebbc719.webp'} />
...
And that’s it! You’re now ready to use Together AI models for conversations in ModelNet.
