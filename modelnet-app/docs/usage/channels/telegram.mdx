---
title: Connect ModelNet to Telegram
description: >-
  Learn how to create a Telegram bot and connect it to your ModelNet agent as a
...
# Connect ModelNet to Telegram

By connecting a Telegram channel to your ModelNet agent, users can interact with the AI assistant through Telegram private chats and group conversations.
...
<Steps>
  ...
  1. Choose a **display name** for your bot (e.g., "ModelNet Assistant")
...
## Step 2: Configure Telegram in ModelNet

<Steps>
  ### Open Channel Settings

  In ModelNet, navigate to your agent's settings, then select the **Channels** tab. Click **Telegram** from the platform list.
  ...
  Click **Save Configuration**. ModelNet will automatically register the webhook URL with Telegram — no manual URL copying is required.
...
Click **Test Connection** in ModelNet's channel settings to verify the integration. Then open Telegram, find your bot by searching its username, and send a message. The bot should respond through your ModelNet agent.
...
To get it: open Telegram, message [@userinfobot](https://t.me/userinfobot), and it will reply with your numeric user ID. Paste it into **Your Platform User ID** in ModelNet's Advanced Settings.
...
- **Webhook registration failed:** Ensure your ModelNet subscription is active. Telegram requires HTTPS endpoints for webhooks, which ModelNet provides automatically.
