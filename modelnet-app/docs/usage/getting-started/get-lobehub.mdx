---
title: Getting ModelNet
description: >-
  Access ModelNet on any device — browser, desktop (macOS/Windows), or mobile
...
ModelNet runs wherever you work — browser, desktop, or phone. Sign in once and your Agents, Pages, and Memory stay in sync across every device.
...
**Best for:** Quick access, trying ModelNet before installing, or using it on shared / restricted machines.
...
Sign in with your ModelNet account to access Agents and conversations on the go.
