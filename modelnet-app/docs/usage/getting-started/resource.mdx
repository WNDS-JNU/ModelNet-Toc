...
- **AI-generated content** — Images created in the Image workspace are saved automatically. View, download, and reuse them in conversations or drafts anytime.
...
- **Notion import** — Import content from Notion into ModelNet for seamless knowledge management across platforms.

**Access the Resource Library** — Click the **Resources** icon at the bottom of the left sidebar on the ModelNet main interface.
...
Export documents from Notion, then import the Notion ZIP file via the **Connect Notion** page. Once imported, you can continue editing these documents within ModelNet.
...
- **Image + Resource Library** — Save generated images to the Resource Library for centralized management of visual assets
