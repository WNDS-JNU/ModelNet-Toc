---
title: 帮助与支持
description: 获取 ModelNet 帮助——常用指南、社区支持、问题反馈及联系方式。
tags:
  - ModelNet
  - 帮助
  - 支持
...
- [获取 ModelNet](/zh/docs/usage/getting-started/get-lobehub) — 浏览器、桌面端或移动端
- [创建你的第一个助理](/zh/docs/usage/getting-started/agent)
- [体验 ModelNet](/zh/docs/usage/getting-started/lobe-ai)
...
| **Reddit**        | 讨论与社区动态      | [r/ModelNet](https://www.reddit.com/r/ModelNet/)                   |
