...
| ------------------------ | ------------------------------------ | ----------------------------------------- |
| **Built-in tools**       | Capabilities built into ModelNet      | Artifacts, Sandbox, GTD, Notebook, Memory |
| **ModelNet Integrations** | OAuth-connected third-party services | Linear, Microsoft, Twitter                |
...
- **ModelNet** — Built-in tools and ModelNet-native integrations (Linear, Microsoft, Twitter, Composio services)
...
Built-in tools (Artifacts, Sandbox, GTD, Notebook) are pre-installed — you can enable them for any Agent immediately. ModelNet Integrations and Composio services require an OAuth connection:

1. In the Skill Store, go to the **ModelNet** tab
...
**Integrations** — Built-in tools, ModelNet-connected services, and Composio integrations. Each shows its connection status. Click **Connect** or **Disconnect** to manage the OAuth link.
