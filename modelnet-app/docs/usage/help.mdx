...
title: Help & Support
description: >-
  Get help with ModelNet — common guides, community support, issue reporting, and
  how to reach us.
tags:
  - ModelNet
  - Help
...
- [Get ModelNet](/docs/usage/getting-started/get-lobehub) — Browser, desktop, or mobile
- [Create Your First Agent](/docs/usage/getting-started/agent)
- [Try ModelNet](/docs/usage/getting-started/lobe-ai)
...
| **Reddit**        | Discussions and community updates         | [r/ModelNet](https://www.reddit.com/r/ModelNet/)                        |
