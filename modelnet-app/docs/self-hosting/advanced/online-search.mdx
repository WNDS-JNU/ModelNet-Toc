...
title: >-
  ...
  Information
description: >-
  Learn how to configure the SearXNG online search functionality for ModelNet,
...
When enabled, ModelNet replaces the Jina endpoints as follows:
...
You can find publicly available SearXNG instances in the [SearXNG instance list](https://searx.space/). Choose an instance that is fast and reliable, and then configure its URL in ModelNet.
...
1. Restart the ModelNet service.
...
- [ModelNet Online Search RFC Discussion](https://github.com/lobehub/lobehub/discussions/6447)
