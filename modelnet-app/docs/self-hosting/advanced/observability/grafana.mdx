...
description: >-
  Monitor and analyze your ModelNet instance using Grafana dashboards, Prometheus
...
ModelNet supports advanced observability for self-hosted deployments using open-source tools:
...
This guide will help you set up and use these tools to monitor your ModelNet instance.
...
2. Start the stack with the correct profile:
   ...
   This will launch Grafana, Prometheus, Tempo, and the otel-collector alongside ModelNet with Casdoor, Minio, and other advanced services.
...
- Verify Prometheus and Tempo are scraping and receiving data from ModelNet and otel-collector.
