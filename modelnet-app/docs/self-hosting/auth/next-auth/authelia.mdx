---
title: Configuring Authelia Authentication Service for ModelNet
description: >-
  Learn how to configure Authelia authentication service in ModelNet, including
  creating a provider, configuring environment variables, and deploying ModelNet.
...
<Steps>
  ...
  Make sure to replace secret and `redirect_urls` with your own values. Note! The secret configured in Authelia is ciphertext, i.e., a salted hash value. Its corresponding plaintext needs to be filled in ModelNet later.
