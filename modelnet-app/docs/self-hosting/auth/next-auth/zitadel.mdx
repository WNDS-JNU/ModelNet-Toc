---
title: Configure ZITADEL Authentication Service for ModelNet
description: >-
  Learn how to configure ZITADEL Authentication Service for ModelNet deployment,
...
<Steps>
  ...
  <Callout type={'important'}>
    ...
    - Replace `http(s)://your-domain` with the actual URL that ModelNet is deployed to.
  </Callout>
...
<Callout>
  After successful deployment, users will be able to authenticate and use ModelNet using existing
