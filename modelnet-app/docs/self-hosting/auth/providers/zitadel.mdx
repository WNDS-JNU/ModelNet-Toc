---
title: Configuring ZITADEL Authentication for ModelNet
description: >-
  Learn how to configure ZITADEL SSO for ModelNet, including creating an
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`  | Required | SSO provider for ModelNet. Use `zitadel` for ZITADEL                           |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with ZITADEL and use ModelNet.
</Callout>
