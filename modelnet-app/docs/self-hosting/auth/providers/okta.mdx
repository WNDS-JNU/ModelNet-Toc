---
title: Configuring Okta Authentication for ModelNet
description: >-
  Learn how to configure Okta SSO for ModelNet, including creating an application
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS` | Required | SSO provider for ModelNet. Use `okta` for Okta                                 |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Okta and use ModelNet.
</Callout>
