---
title: Configuring Authentik Authentication for ModelNet
description: >-
  Learn how to configure Authentik SSO for ModelNet, including creating an OAuth2
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`    | Required | SSO provider for ModelNet. Use `authentik` for Authentik                       |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authentik and use ModelNet.
</Callout>
