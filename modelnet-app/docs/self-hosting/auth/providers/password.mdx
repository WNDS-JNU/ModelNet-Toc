---
title: Configuring Email/Password Authentication for ModelNet
description: >-
  Learn how to configure email and password authentication for ModelNet,
...
ModelNet supports traditional email and password authentication out of the box.
