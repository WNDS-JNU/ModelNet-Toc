---
title: Configuring Cloudflare Zero Trust Authentication for ModelNet
description: >-
  Learn how to configure Cloudflare Zero Trust SSO for ModelNet, including
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`                | Required | SSO provider for ModelNet. Use `cloudflare-zero-trust`                         |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Cloudflare Zero Trust and use ModelNet.
</Callout>
