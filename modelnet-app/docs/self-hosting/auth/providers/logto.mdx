---
title: Configuring Logto Authentication for ModelNet
description: >-
  Learn how to configure Logto SSO for ModelNet, including creating an
...
<Steps>
  ...
  4. Fill in the application name: `ModelNet`
  ...
  | `AUTH_SSO_PROVIDERS`        | Required | SSO provider for ModelNet. Use `logto` for Logto                               |
  ...
  Configure Logto [Webhook](https://docs.logto.io/developers/webhooks/configure-webhooks) to sync user data updates to ModelNet.
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Logto and use ModelNet.
</Callout>
