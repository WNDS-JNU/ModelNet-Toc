---
title: Configuring Auth0 Authentication for ModelNet
description: >-
  Learn how to configure Auth0 SSO for ModelNet, including creating applications,
...
<Callout type={'warning'}>
  When creating a GitHub connection, make sure to enable the **Email Address** permission in the **Attributes** section. ModelNet requires user email for authentication.
