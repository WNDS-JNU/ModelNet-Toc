---
title: 在 ModelNet 中配置 ZITADEL 身份验证
description: 学习如何在 ModelNet 中配置 ZITADEL SSO，包括创建应用和设置环境变量。
tags:
  - ZITADEL
  - 身份验证
  - ModelNet
...
<Callout type={'info'}>部署成功后，用户将可以通过 ZITADEL 身份认证并使用 ModelNet。</Callout>
