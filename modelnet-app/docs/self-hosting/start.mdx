---
title: Build Your Own ModelNet - Choose Your Deployment Platform
description: >-
  Explore multiple deployment platforms like Vercel, Docker, Docker Compose, and
  more to deploy ModelNet. Choose the platform that best suits your needs.
tags:
  - ModelNet
  - Deployment Platform
  - Vercel
...
# Build Your Own ModelNet

ModelNet can be self-hosted on your own infrastructure, giving you complete control over your data, customization, and deployment environment. Whether you're deploying for a team, organization, or personal use, ModelNet supports multiple deployment methods.

<PlatformCards urlPrefix={'platform'} />

## Architecture Overview

ModelNet consists of several key components:
...
Before deploying ModelNet, gather the following:
...
5. **Regular updates** — Keep ModelNet and dependencies up to date
