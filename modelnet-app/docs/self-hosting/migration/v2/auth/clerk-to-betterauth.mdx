...
description: >-
  Guide for migrating your ModelNet deployment from Clerk authentication to
...
This guide helps you migrate your existing Clerk-based ModelNet deployment to Better Auth.
...
4. **Notify Users**
   ...
   ![ModelNet Login Page - Social Login Hint](https://hub-apac-1.lobeobjects.space/docs/8d0563701fcd17ad7252a72b1746dd42.png)
...
bun run scripts/clerk-to-betterauth/export-clerk-users-with-api.ts
```
...
bun run scripts/clerk-to-betterauth/index.ts
```
...
bun run scripts/clerk-to-betterauth/verify.ts
```
