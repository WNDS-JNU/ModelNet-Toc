---
title: 'ModelNet v1.6: GPT-4o Mini Joins the Default Lineup'
description: >-
  ModelNet v1.6 adds GPT-4o mini support, while ModelNet Cloud upgrades its
...
# ModelNet v1.6: GPT-4o Mini Joins the Default Lineup

OpenAI's full model family has moved to GPT-4. ModelNet v1.6 follows that shift, adding GPT-4o mini to the supported models. For ModelNet Cloud users, this upgrade goes further: GPT-4o mini is now the default, replacing GPT-3.5-turbo.
...
For ModelNet Cloud users, the service upgrade is automatic. New conversations start with GPT-4o mini by default. Existing users don't need to change any settings—the model switcher simply shows the new default first.
...
- Updated ModelNet Cloud default model selection logic
