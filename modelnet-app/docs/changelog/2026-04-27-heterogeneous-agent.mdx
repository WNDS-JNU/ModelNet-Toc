...
- **Quick Chat on desktop.** Capture your screen and ask ModelNet about it.
- **New models.** GPT-5.5, DeepSeek V4 Flash and Pro with a reasoning-effort slider, ModelNet-hosted gpt-image-2, Kimi K2.6, and MiMo-V2.5 and Pro.
