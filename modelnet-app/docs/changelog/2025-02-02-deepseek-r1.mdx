...
description: >-
  ModelNet now supports DeepSeek R1 with real-time reasoning display, making
...
ModelNet v1.49.12 now supports DeepSeek R1 across both Community and Cloud editions. This integration brings the model's reasoning process into full view, so you can follow how complex questions are solved step by step.
...
1. Upgrade to ModelNet v1.49.12 or visit [ModelNet.com](https://ModelNet.com)
