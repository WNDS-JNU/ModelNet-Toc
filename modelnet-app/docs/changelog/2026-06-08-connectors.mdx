...
description: >-
  Govern every tool with the new Connectors system, run Connect Agents on your
  own device, and track spending right in the activity heatmap.
tags:
  - Connectors
  - Connect Agent
  - Insights
