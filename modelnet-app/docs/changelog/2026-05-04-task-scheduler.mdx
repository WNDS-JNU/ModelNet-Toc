...
description: >-
  Delegate Claude Code and Codex from inside ModelNet, with a redesigned home, a
...
- **Delegate Claude Code and Codex.** Control coding agents inside ModelNet: click Create Agent and choose your coding agent. Desktop only.
