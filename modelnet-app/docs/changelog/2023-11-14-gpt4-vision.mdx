...
description: >-
  ModelNet now supports multimodal models including GPT-4 Vision, Google Gemini
...
Conversations in ModelNet are no longer limited to text. We now support several large language models with visual recognition capabilities, including OpenAI's [`gpt-4-vision`](https://platform.openai.com/docs/guides/vision), Google Gemini Pro Vision, and Zhiyuan GLM-4 Vision.
