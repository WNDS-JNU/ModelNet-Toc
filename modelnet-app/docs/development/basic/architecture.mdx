...
description: >-
  Explore the architecture of ModelNet, an open-source AI Agent platform built on
...
ModelNet is an open-source AI Agent platform built on Next.js, enabling users to interact with AI through natural language, use tools, manage knowledge bases, and more. The following is an overview of ModelNet's architecture design.

## Application Architecture Overview

The overall architecture of ModelNet consists of the following core layers:
...
ModelNet uses [Better Auth](https://www.better-auth.com/) as the authentication framework, supporting:
