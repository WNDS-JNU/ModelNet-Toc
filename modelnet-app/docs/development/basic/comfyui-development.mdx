...
description: >-
  Learn how to add new models, workflows, and features to ModelNet's ComfyUI
  integration
tags:
  - ComfyUI
  - Development Guide
...
This guide is based on actual code implementation and helps developers extend ModelNet's ComfyUI integration functionality.

## Architecture Overview

ModelNet ComfyUI integration uses a four-layer service architecture built around the main `LobeComfyUI` class:
...
apps/server/src/services/comfyui/ # Server-side implementation
...
```typescript
import { LobeComfyUI } from '@lobechat/model-runtime';
