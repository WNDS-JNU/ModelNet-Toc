...
description: >-
  Explore the ModelNet development setup, technology stack, and contribution
  guidelines.
tags:
  - ModelNet
  - Next.js
...
Welcome to the ModelNet Technical Development Getting Started Guide. ModelNet is an AI conversation application built on the Next.js framework, incorporating a range of technology stacks to achieve diverse functionalities and features. This guide will detail the main technical components of ModelNet and how to configure and use these technologies in your development environment.

## Basic Technology Stack

The core technology stack of ModelNet is as follows:
...
ModelNet uses a Monorepo architecture
(`@lobechat/` namespace).
...
ModelNet uses `react-i18next` for multilingual support,
...
To support developers in better understanding and using the technology stack of ModelNet, we provide a comprehensive list of resources and references — [ModelNet Resources and References](/docs/development/basic/resources) - Visit our maintained list of resources, including tutorials, articles, and other useful links.

We encourage developers to utilize these resources to deepen their learning and enhance their skills, join community discussions through [ModelNet GitHub Discussions](https://github.com/lobehub/lobehub/discussions) or [Discord](https://discord.com/invite/AYFPHvv2jT), ask questions, or share your experiences.
