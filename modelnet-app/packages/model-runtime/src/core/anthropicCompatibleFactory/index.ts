...
/**
 * Build the default Anthropic Messages payload with ModelNet normalization.
 */
export const buildDefaultAnthropicPayload = async (
  ...
  // normalizeTemperature divides by 2 to map ModelNet's 0-2 range to Anthropic's 0-1 range.
