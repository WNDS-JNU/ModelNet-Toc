 ...
 * because they're emitted solely by the managed ModelNet Cloud gateway. They're
...
export const ERROR_CODE_SPECS: SpecMap = {
  ...
  [ChatErrorType.FreePlanLimit]: {
    ...
    retryable: false,
    countAsFailure: false,
    description: 'ModelNet Cloud free-plan usage limit reached.',
  },
  [ChatErrorType.InsufficientBudgetForModel]: {
    ...
    retryable: false,
    countAsFailure: false,
    description: 'ModelNet Cloud balance is positive but below the model’s estimated cost.',
  },
  ...
  [ChatErrorType.LobeHubModelDeprecated]: {
    ...
    retryable: false,
    countAsFailure: false,
    description: 'Requested ModelNet Cloud model has been deprecated / removed.',
  },
