 ...
 * instrumentation, alongside ModelNet-specific (`lobehub.*`) extensions.
 *
...
// ---- lobehub.* (ModelNet-specific extensions) ----
...
/** Internal ModelNet tool source (`builtin` / `client` / `mcp` / `composio` / `lobehubSkill`). */
