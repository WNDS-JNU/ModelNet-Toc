          ...
          evidence: {
            ...
            items: {
              properties: {
                ...
                documentId: {
                  description:
                    'An existing ModelNet document id from documents.id. Do not use an agent_documents.id binding id.',
                  type: 'string',
                },
                fileId: { description: 'An existing ModelNet artifact file id.', type: 'string' },
                type: {
