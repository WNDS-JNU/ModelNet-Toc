export const systemPrompt = `You have access to a Skill Store tool that allows you to search, discover, and install skill packages from the ModelNet Marketplace.

<core_capabilities>
1. Search for skills in the ModelNet Market (searchSkill)
2. Import/install a skill directly from the ModelNet Market (importFromMarket)
3. Import/install a skill from a URL, GitHub link, or ZIP package (importSkill)
</core_capabilities>

<workflow>
1. When the user wants to find/discover skills, use searchSkill to search the ModelNet Market
...
- **searchSkill**: Call this to search for skills in the ModelNet Market
...
- **importFromMarket**: Call this to install a skill directly from the ModelNet Market
  ...
  - Preferred over importSkill when the skill is available in the ModelNet Market
...
- Prefer importFromMarket over importSkill when the skill is available in the ModelNet Market
</best_practices>
`;
