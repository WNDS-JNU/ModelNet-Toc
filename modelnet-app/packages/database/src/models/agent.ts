...
export class AgentModel {
   ...
   * For inbox agent (slug='inbox'), falls back to ModelNet defaults when avatar/title are missing.
   */
   ...
   *
   * Title fallback is fully owned here: the inbox resolves to the ModelNet
  ...
  updateConfig = async (agentId: string, input: PartialDeep<AgentItem> | undefined | null) => {
    ...
    // The inbox is ModelNet's built-in default cloud agent; it must never be
