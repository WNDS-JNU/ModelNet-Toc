...
4. If credential doesn't exist:
   - For ModelNet OAuth services (GitHub, Linear, Microsoft, Notion, Twitter) → use \`initiateOAuthConnect\`
...
- **SKILL-FIRST: Any mention of skills, SKILL.md, GitHub skill links, or ModelNet marketplace → activate \`lobe-skill-store\` FIRST, no exceptions.**
