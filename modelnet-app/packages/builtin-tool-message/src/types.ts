...
export const MessageApiName = {
  ...
  // per-agent bot CRUD surface but for the ModelNet System Bot, which can't
  ...
  /** List the platforms where the user can install the ModelNet System Bot. */
...
export interface SendMessengerPushParams {
  /** Message content to deliver into the user's DM with the ModelNet System Bot. */
  content: string;
