...
export const ModelNetParallelSourceSchema = z
  .object({
    backend: z.record(z.string(), z.unknown()).optional(),
...
export const ModelNetParallelMetadataSchema = z
  .object({
    ...
    sources: z.record(z.string(), ModelNetParallelSourceSchema).optional(),
    synthesis: z.record(z.string(), z.unknown()).optional(),
    updatedAt: z.number().optional(),
  })
  .passthrough();

export type ModelNetParallelSourceState = z.infer<typeof ModelNetParallelSourceSchema>;
export type ModelNetParallelMetadata = z.infer<typeof ModelNetParallelMetadataSchema>;
