export default {
  ...
  'artworkStudio.style.lobe': 'ModelNet Style',
  ...
  'heterogeneousStatus.apiMode.labDisabled':
    'API mode is a Labs experiment. Enable it to use the ModelNet default provider or a configured API provider instead of the agent subscription.',
  'heterogeneousStatus.apiMode.localOnly': 'Available only for Desktop local execution',
  'heterogeneousStatus.apiMode.defaultProvider': 'ModelNet',
  ...
  'devices.connectWizard.desktop.step1Desc':
    'Visit the ModelNet downloads page and get the app for your operating system.',
  ...
  'devices.connectWizard.subtitle': 'Choose how to connect your computer to ModelNet.',
  'devices.connectWizard.title': 'Connect Device',
  'devices.empty.desc':
    'Once connected, ModelNet agents can read/write files, run commands, and call system tools directly on your computer.',
  ...
  'apps.cli.copy': 'Copy',
  'apps.cli.desc': 'Scripts, cron jobs, and headless agents — the same ModelNet, from any terminal.',
  'apps.cli.title': 'CLI',
  ...
  'apps.messenger.desc':
    'Talk to your agents where your team already is — replies land back in ModelNet.',
  ...
  'apps.title': 'Do more with ModelNet, everywhere you work',
  ...
  'notification.im.desc':
    'Deliver notifications to your linked messenger (Telegram, Discord, Slack, or WeChat) via the ModelNet bot',
  'notification.im.linkAccount': 'Link account',
  'notification.im.title': 'Messenger Notifications',
  'notification.im.platform.desc':
    'Deliver notifications to your {{platform}} DM via the ModelNet bot',
  ...
  'notification.push.desc':
    'Send push notifications to your mobile devices (ModelNet mobile app required)',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'workspace.apiKey.upgrade.benefits.integration.desc':
    'Call workspace agents and resources from your own systems via the ModelNet API.',
  ...
  'workspace.general.avatar.description':
    "This is your workspace's avatar. Upload your own, or generate one in the ModelNet official style.",
  ...
  'tools.builtins.lobe-image-generation.description':
    'Generate images through ModelNet providers when the current chat model has no native image output.',
  ...
  "devices.remove.confirmManyDesc": "This disconnects the selected devices from your account. They are not signed out, and each can re-register on next connect.",
  ...
  "workspace.billingPage.plans.headerNote.active": "You are on the {{plan}} plan. If you have any questions or would like further support with your plan, <contact>contact us</contact>",
  "workspace.billingPage.plans.headerNote.renewing": "You are on the {{plan}} plan, renewing {{date}}. If you have any questions or would like further support with your plan, <contact>contact us</contact>",
