export default {
  ...
  'messenger.detail.commands.feedback':
    'Send feedback to the ModelNet team (no AI reply), e.g. /feedback your message',
  ...
  'messenger.detail.commands.start': 'Link your account to ModelNet',
  ...
  'messenger.linkModal.instructions':
    'Open the bot, send /start, then tap "Link Account" to connect your ModelNet account.',
  ...
  'messenger.slack.connectModal.description':
    'You will be redirected to Slack to authorize the ModelNet workspace install.',
  ...
  'messenger.slack.connections.disconnectConfirm':
    'Disconnect the ModelNet bot from this Slack workspace? Existing user links will pause until you re-install.',
  ...
  'messenger.slack.installBlocked.suggestion':
    "DM @ModelNet on Slack to link your personal account — you don't need to install again. Or ask the original installer to disconnect this workspace first if you want to take over ownership.",
  'messenger.slack.installBlocked.title': 'Workspace already connected',
  'messenger.slack.installBlocked.withName':
    '"{{workspace}}" is already connected to ModelNet by another user.',
  'messenger.slack.installBlocked.withoutName':
    'This Slack workspace is already connected to ModelNet by another user.',
  ...
  'messenger.discord.connectModal.description':
    'Add the ModelNet bot to a Discord server you manage.',
  ...
  'messenger.discord.installBlocked.suggestion':
    "DM the ModelNet bot on Discord to link your personal account — you don't need to add the bot again. Or ask the original installer to remove this server in ModelNet Settings → Messenger before re-adding it.",
  ...
  'messenger.discord.installBlocked.withoutName':
    'This Discord server is already connected to ModelNet by another user.',
  ...
  'messenger.list.discord.description':
    'Chat with your ModelNet agents on Discord by DMing the ModelNet bot from any server.',
  'messenger.list.slack.description':
    'Chat with your ModelNet agents on Slack by DMing or mentioning @ModelNet in any workspace.',
  'messenger.list.telegram.description':
    'Chat with your ModelNet agents on Telegram, and choose which agent replies.',
  'messenger.setActiveFailed': 'Failed to set as active.',
  'messenger.setActiveSuccess': 'Active agent updated.',
  'messenger.subtitle':
    'Connect your account to the official ModelNet bot once. Pick which agent receives messages, switch any time from here or from the bot.',
  'messenger.title': 'Messenger',
  'messenger.unlinkConfirm':
    'Disconnect your {{platform}} account from ModelNet? Inbound messages will stop until you /start again.',
  ...
  'messenger.wechat.error.alreadyLinkedToOther':
    'This WeChat account is already connected to another ModelNet account.',
  ...
  'verify.confirm.conflict.description':
    'This {{platform}} account is already linked to ModelNet account {{email}}. Sign in to that account to manage the link, or unlink there before retrying.',
  ...
  'verify.confirm.fields.lobeHubAccount': 'ModelNet account',
  'verify.confirm.fields.platformAccount': '{{platform}} account',
  'verify.confirm.fields.workspace': 'Workspace',
  'verify.confirm.noAgents':
    "You don't have any agents yet. Create one in ModelNet, then come back to finish linking.",
  'verify.confirm.relink.description':
    'This ModelNet account is already linked to {{platform}} account {{account}}. To link a different {{platform}} account, disconnect the current one first in Settings → Messenger.',
  ...
  'verify.error.alreadyConsumed':
    'This link has already been used to connect an account. Sign in to that ModelNet account to manage the connection, or return to the bot and send /start again to issue a new link.',
  'verify.error.alreadyConsumedTitle': 'This link is already used',
  'verify.error.alreadyLinkedToOther':
    'This account is already linked to a different ModelNet account. Sign in to that account first.',
  ...
  'verify.error.unlinkBeforeRelink':
    'This ModelNet account is already linked to another account on this platform. Disconnect it in Settings → Messenger before linking a new one.',
  'verify.signInCta': 'Sign in to continue',
  'verify.signInRequired': 'Please sign in to ModelNet to confirm the link.',
  ...
  "messenger.list.wechat.description": "Scan with WeChat to chat privately with your ModelNet agents and switch agents with /agents.",
  "messenger.paidBadge": "Pro",
  "messenger.push.alwaysAvailable": "Ready to send",
  "messenger.push.alwaysAvailableHint": "Messages go to your linked {{platform}} account as a direct message.",
  "messenger.push.alwaysDescription": "The bot can proactively send direct messages to your linked {{platform}} account at any time.",
  ...
  "messenger.push.queuedBusyToast": "Another message is still being delivered — yours is queued behind it. Message the bot in {{platform}} to receive it.",
  "messenger.push.queuedQuotaToast": "No sends left in this window — your message is queued. Message the bot in {{platform}} to reset the window and receive it.",
  "messenger.push.queuedRetryToast": "Part of your message could not be delivered — the rest is queued and will be retried after you message the bot in {{platform}}.",
  ...
  "messenger.push.resource.oversizeImageCompressHint": "Re-encoded as a JPEG under {{limit}} so it shows up inline. Some quality is lost, and an animated image cannot be compressed — it is sent as a link instead.",
  "messenger.push.resource.oversizeImageLink": "Send a link",
  "messenger.push.resource.oversizeImageLinkHint": "The original file is sent as a download link — full quality, but not shown inline in the chat.",
  ...
  "messenger.push.sentWindowedToast": "Sent to {{platform}} ({{remaining}} sends left in this window).",
  ...
  "messenger.push.unlinkedToast": "Your {{platform}} connection is unavailable. Reconnect it and try again.",
  ...
  "messenger.push.windowedDescription": "{{platform}} only lets the bot message you inside a send window — reply anything to reset it to {{max}} sends / 24 hours.",
  "messenger.unlinkConfirmWechat": "Disconnect your WeChat account from ModelNet? Inbound messages will stop until you scan the QR code to reconnect.",
  "verify.success.backToLobeHub": "Back to ModelNet",
};
