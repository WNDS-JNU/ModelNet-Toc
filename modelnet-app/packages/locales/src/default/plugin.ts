export default {
  ...
  'builtins.lobe-agent.title': 'ModelNet Agent',
  ...
  'protocolInstall.official.badge': 'ModelNet Official Skill',
  'protocolInstall.official.description': 'Official ModelNet Skill, verified and security-checked.',
  ...
  'protocolInstall.stdio.commandExecution.description':
    'STDIO MCPs connect through a local command. During installation, ModelNet will start the command shown below to test the connection. Continue only if you trust this source.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. ModelNet does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.dismiss': 'Dismiss',
  'skillInstallBanner.title': 'Connect your favorite apps to ModelNet',
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'ModelNet Skills',
