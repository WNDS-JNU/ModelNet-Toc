export default {
  ...
  'heteroAgent.claudeQuota.calendar.noLedgerSpendHint':
    'Token history is only recorded for runs started in ModelNet after usage tracking was enabled. Earlier usage and runs started directly from the terminal cannot be backfilled.',
  ...
  'heteroAgent.apiMode.agentUnsupported': '{{name}} does not support ModelNet Provider binding.',
  ...
  'heteroAgent.apiMode.defaultProviderConfigMissing':
    'ModelNet requires a compatible model. Open the agent profile to select one.',
  ...
  'heteroAgent.executionTarget.infoTooltip':
    'Pick a device and the agent uses it as its runtime environment — reading and writing files and operating the computer. Cloud sandbox is provided by ModelNet Marketplace.',
  ...
  'ampInstallGuide.reason': 'ModelNet could not start Amp: {{message}}',
  ...
  'claudeCodeInstallGuide.reason': 'ModelNet could not start Claude Code: {{message}}',
  ...
  'codeBuddyInstallGuide.reason': 'ModelNet could not start CodeBuddy: {{message}}',
  ...
  'codexInstallGuide.reason': 'ModelNet could not start Codex: {{message}}',
  ...
  'cursorInstallGuide.reason': 'ModelNet could not start Cursor: {{message}}',
  ...
  'grokBuildInstallGuide.reason': 'ModelNet could not start Grok Build: {{message}}',
  ...
  'opencodeInstallGuide.reason': 'ModelNet could not start OpenCode: {{message}}',
  ...
  'piInstallGuide.reason': 'ModelNet could not start Pi: {{message}}',
  ...
  'qoderInstallGuide.reason': 'ModelNet could not start Qoder: {{message}}',
  ...
  'kimiCodeInstallGuide.reason': 'ModelNet could not start Kimi Code: {{message}}',
  ...
  'traeInstallGuide.reason': 'ModelNet could not start TRAE CLI: {{message}}',
  ...
  'gatewayMode.desc':
    "Run agents in the cloud through ModelNet's Agent Gateway. Tasks keep running even after you close the page.",
  ...
  'plus.search.appSearchDesc':
    'ModelNet optimized search service, delivering best retrieval results.',
  ...
  'sharePage.menu.goToLobeHub': 'Go to ModelNet',
  ...
  'sharePageDisclaimer':
    "Shared by a user. The content reflects their views, not ModelNet's, and ModelNet takes no responsibility for it.",
  ...
  'taskList.unassignedHint': 'ModelNet will run this task when no assignee is set',
  ...
  "connectAgent.create.noneDetectedHint": "Install a supported agent on that machine, then rescan. For example:",
  ...
  "heteroAgent.executionTarget.noWorkspaceDevices": "No workspace devices yet. Run `{{cmd}}` on a machine to enroll it for every member.",
  "agent.publishToWorkspaceConfirm": "Other workspace members will be able to use this agent. You will not be able to make it private again.",
  "chatList.refreshing": "Fetching latest messages...",
  "heteroAgent.codexQuota.compactLeft": "{{percent}}%",
  "heteroAgent.codexQuota.duration.day_one": "{{count}}d",
  "heteroAgent.codexQuota.duration.day_other": "{{count}}d",
  "heteroAgent.codexQuota.duration.hour_one": "{{count}}h",
  "heteroAgent.codexQuota.duration.hour_other": "{{count}}h",
  "heteroAgent.codexQuota.duration.minute_one": "{{count}}m",
  "heteroAgent.codexQuota.duration.minute_other": "{{count}}m",
  "heteroAgent.codexQuota.left": "{{percent}}% left",
  "heteroAgent.codexQuota.nextExpiresIn": "Next expires in {{duration}}",
  "heteroAgent.codexQuota.noData": "Codex quota is not available yet.",
  "heteroAgent.codexQuota.refresh": "Refresh Codex quota",
  "heteroAgent.codexQuota.resetsIn": "Resets in {{duration}}",
  "heteroAgent.codexQuota.resetsSoon": "Resets soon",
  "heteroAgent.codexQuota.session": "Session",
  "heteroAgent.codexQuota.unavailable": "Codex quota is unavailable.",
  "heteroAgent.codexQuota.updatedAgo": "Updated {{duration}} ago",
  "heteroAgent.codexQuota.updatedJustNow": "Updated just now",
  "heteroAgent.codexQuota.weekly": "Weekly",
  "input.sandboxModeNotice": "Running in a temporary Cloud Sandbox. Local runs are faster and can access your files.",
  ...
  "taskDetail.publishToWorkspace.confirmContent": "Once published, this task becomes visible to all workspace members and cannot be reverted to private.",
