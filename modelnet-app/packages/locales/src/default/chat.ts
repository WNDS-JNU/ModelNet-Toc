export default {
  ...
  'heteroAgent.codexQuota.errorConnection':
    "Couldn't reach the Codex quota endpoint. Check your network or ModelNet proxy settings.",
  ...
  'goalProcess.gate.why': 'Why it stopped',
  'goalProcess.gate.options': 'What each choice means',
  'goalProcess.gate.recommended': 'recommended',
  'goalProcess.gate.noteLabel': 'Extra guidance (optional — goes into the next attempt)',
  'goalProcess.gate.notePlaceholder':
    'e.g. reuse the existing checkpoint instead of retraining from scratch',
  ...
  'goalProcess.edge.dependsOn': 'depends on',
