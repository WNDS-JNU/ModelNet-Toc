export default {
  ...
  'navigation.leaderboard': 'Model Leaderboard',
  'navigation.lobehub': 'ModelNet',
  ...
  'remoteServer.configDesc': 'Connect to the remote ModelNet server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'ModelNet Cloud',
