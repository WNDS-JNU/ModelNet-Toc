export default {
  ...
  'messengerBanner.title': 'Talk to ModelNet on your favorite messaging apps',
  'branching': 'Create Subtopic',
  'branchingDisable':
    'The "Sub-topic" feature is unavailable in the current mode. To use this feature, please switch to Postgres/Pglite DB mode or use ModelNet Cloud.',
  ...
  'cmdk.keywords.leaderboard': 'leaderboard benchmark modelnet opencompass rank capability',
  ...
  'cmdk.memory': 'Memory',
  'cmdk.leaderboard': 'Model Leaderboard',
  ...
  'taskTemplate.action.create.success': 'Scheduled task added. Find it in ModelNet.',
