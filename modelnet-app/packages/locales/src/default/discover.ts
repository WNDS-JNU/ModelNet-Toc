export default {
  ...
  'assistants.status.support':
    'For any questions, copy the link and contact your ModelNet administrator for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and contact your ModelNet administrator.',
  ...
  'createGuide.func1.title': 'Submit in ModelNet',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the ModelNet Community.',
  'footer.title': 'Share your creation on ModelNet Community today',
  ...
  'models.providerInfo.apiTooltip': 'ModelNet supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'ModelNet Official Service',
  ...
  'skills.details.sidebar.agent.useOnModelNet': 'Use on ModelNet',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by ModelNet automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the ModelNet marketplace with one click.',
