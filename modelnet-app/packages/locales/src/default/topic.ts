export default {
  ...
  'heteroImport.badge.linked': 'From ModelNet',
  'heteroImport.badge.linkedTip':
    'This session was started from ModelNet and already lives in your topic list',
  ...
  'heteroImport.error.desc':
    'Could not read the local sessions. Check that ModelNet can access your transcripts, then retry.',
