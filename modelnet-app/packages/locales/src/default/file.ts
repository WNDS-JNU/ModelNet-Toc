export default {
  ...
  'notSupportGuide.desc':
    'The current deployment mode does not support file management. Switch to <1>server database deployment mode</1>, or use <3>ModelNet Cloud</3>.',
  ...
  'pageEditor.comments.empty': 'No comments yet. Start the conversation below.',
  ...
  "library.publishConfirm.content": "All workspace members will see this knowledge base. This action cannot be undone.",
  "pageList.publishConfirm.content": "After publishing, everyone in the workspace can see this page. You can’t change it back to private later.",
};
