export default {
  ...
  'email.footer.preference':
    'You received this email because of your notification settings on ModelNet.',
  'email.footer.system': 'This is an important account notification from ModelNet.',
  ...
  'workspace_waitlist_approved':
    'Your Workspace beta access is ready. Head to ModelNet to create your first workspace and invite your team.',
