export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using ModelNet Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve ModelNet. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve ModelNet',
  ...
  'screen5.actions.signInCloud': 'Sign in to ModelNet',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your ModelNet account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'ModelNet',
  'screen5.methods.selfhost.description': 'Connect to your own ModelNet server instance',
