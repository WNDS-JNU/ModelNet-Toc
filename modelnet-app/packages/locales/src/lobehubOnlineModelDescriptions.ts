/**
 * ModelNet provider-scoped model description defaults (`lobehub.${id}.description`).
 *
 * Sourced from ModelNet online model config. Prefer updating that source over hand-editing.
