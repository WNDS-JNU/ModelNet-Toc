...
export const DEFAULT_AVATAR = '/avatars/modelnet.png';
...
export const DEFAULT_INBOX_AVATAR = BRANDING_LOGO_URL || '/avatars/modelnet.png';
export const DEFAULT_INBOX_TITLE = 'ModelNet';
