...
**gitignored** — reports are per-run artifacts, published to ModelNet Acceptance,
not committed.
...
`modelnet acceptance install` only places the skill files; it does no repo exploration.
