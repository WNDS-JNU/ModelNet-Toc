/**
 * ModelNet Skill Server connection status
 */
...
/**
 * ModelNet Skill Tool definition (from Market API)
 */
...
/**
 * ModelNet Skill Provider definition (from Market API)
 */
...
/**
 * ModelNet Skill Server instance (user-connected provider)
 */
...
/**
 * Parameters for calling ModelNet Skill tool
 */
...
/**
 * Result of calling ModelNet Skill tool
 */
