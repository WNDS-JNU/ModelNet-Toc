export default {
  ...
  'memory.enabled.desc':
    'Allow ModelNet to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'settingAppearance.appTray.desc':
    'Show the ModelNet icon in the system tray or macOS menu bar. Disabling it also removes tray menu access.',
  ...
  'settingSelfIteration.enabled.managedDesc':
    'Always on for ModelNet while Self-Iteration is available.',
  ...
  'settingSystemTools.tools.lobehub.desc': 'ModelNet CLI - manage and connect to ModelNet services',
  ...
  'skillStore.tabs.lobehub': 'ModelNet',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tools.builtins.lobe-skill-store.description':
    'Browse and install agent skills from the ModelNet marketplace. Use this when you need extended capabilities or want to install a specific skill.',
  ...
  'tools.builtins.lobehub.description':
    'Manage the ModelNet platform via CLI — knowledge bases, memory, agents, files, search, generation, and more.',
  'tools.builtins.lobehub.title': 'ModelNet',
