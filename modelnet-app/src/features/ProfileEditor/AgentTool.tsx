...
const AgentTool = memo<AgentToolProps>(
  ({
    ...
    // ModelNet Skill Provider list items
    ...
    // Merge Builtin Agent Skills, builtin tools, ModelNet Skill Providers, and Composio servers
    ...
    const validIdentifiers = useMemo(() => {
      ...
      // 4. ModelNet Skill providers (if enabled)
