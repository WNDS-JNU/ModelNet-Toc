...
/** A ModelNet Market connector that still requires provider authorization. */
...
export interface ResolvePendingAuthToolsInput {
  ...
  /** Whether the first ModelNet Market connection request has settled. */
  lobehubInitialized: boolean;
  /** Current ModelNet Market connection states. */
