...
const createMainAreaChildrenDefinition = (options: MainAreaRouteOptions = {}): RouteObject[] => [
  ...
  // ModelNet leaderboard (personal-only).
  {
    element: dynamicElement(
      () => import('@/routes/(main)/leaderboard'),
      'Desktop > ModelNet Leaderboard',
    ),
    errorElement: <ErrorBoundary />,
    handle: {
      meta: routeMeta({ icon: Trophy, titleKey: 'navigation.leaderboard' }),
    },
    path: 'leaderboard',
  },
