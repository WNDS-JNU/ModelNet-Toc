...
description: >
  Bot-channel end-to-end verification for ModelNet — drives the real native chat
...
# Agent Testing — Bot Channels (ModelNet project skill)
...
For ModelNet environment/auth/probe specifics (dev server, seeded account, ports),
