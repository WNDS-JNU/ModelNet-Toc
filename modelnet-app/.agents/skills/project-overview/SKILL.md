...
description: 'ModelNet open-source monorepo architecture map. Use when locating code layers, understanding apps/packages/src layout, business stubs, project structure, or onboarding to the repository.'
user-invocable: false
---

# ModelNet Project Overview
...
Open-source, modern-design AI Agent Workspace: **ModelNet** (previously ModelNet).
