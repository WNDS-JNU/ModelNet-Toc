...
> here turns out to be product-independent, genericize it (drop the ModelNet
> nouns) and PR it upstream.
>
> Most of the historically accumulated cases were promoted to the generic layer;
> what remains here is the ModelNet-platform-specific residue (the verify /
...
> keeps the ModelNet-specific framing of an authorization/permission change as a UI surface. Candidate
> to genericize + upstream if it stops being ModelNet-specific.
