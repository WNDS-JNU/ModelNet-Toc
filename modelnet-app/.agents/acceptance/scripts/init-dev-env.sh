...
#
# This script initializes the env needed to run ModelNet's normal local dev
...
write_env() {
  ...
  {
    printf '# Source this file before starting ModelNet local dev server.\n'
...
const writeCliEnvFile = () => {
  ...
  fs.writeFileSync(
    file,
    [
      '# Source this file before running ModelNet CLI agent tests.',
