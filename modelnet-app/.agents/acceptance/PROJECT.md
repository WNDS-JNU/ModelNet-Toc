# PROJECT.md — acceptance adapter for ModelNet

This file is the **commands** layer of ModelNet's acceptance setup: every
ModelNet-specific command, port, service, surface, and probe. The `acceptance`
skill reads it — it never guesses ModelNet's commands.
