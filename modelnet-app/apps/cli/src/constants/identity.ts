 ...
 *
 * The values below define the ModelNet distribution while retaining selected
 * legacy environment variable names for CLI compatibility.
 */

/** Product name as it appears inside sentences. */
export const CLI_PRODUCT_NAME = 'ModelNet';

/** The CLI's own name, e.g. in `--help` and the connect banner. */
export const CLI_DISPLAY_NAME = 'ModelNet CLI';

/**
 * The command users type. Also the man page's title (uppercased) and the name
 * shown in "run `<bin> login`" hints.
 */
export const CLI_PRIMARY_BIN = 'modelnet';
 ...
 */
export const CLI_COMPLETION_FUNCTION = '_modelnet_completion';

/** Directory under $HOME holding settings, credentials and daemon state. */
export const CLI_CONFIG_DIR_NAME = '.modelnet';
 ...
 */
export const CLI_COMPLETION_CWORD_ENV = 'MODELNET_COMP_CWORD';

/** systemd unit name for `connect service`. */
export const CLI_CONNECT_SERVICE_NAME = 'modelnet-connect.service';
 ...
 */
export const CLI_API_KEY_ENV_NAMES: readonly string[] = [
  'MODELNET_CLI_API_KEY',
  'LOBEHUB_CLI_API_KEY',
];
export const CLI_HOME_ENV_NAMES: readonly string[] = ['MODELNET_CLI_HOME', 'LOBEHUB_CLI_HOME'];
