...
/**
 * E2E tests for `modelnet agent-signal trigger`.
 *
 ...
 * - `modelnet` (or LH_CLI_PATH) points at the built CLI
 * - User is authenticated (`modelnet login`) against a dev server with Agent Signal enabled
...
describe.skipIf(!AGENT_ID)('modelnet agent-signal trigger - live', () => {
