...
ModelNet Desktop 是 [ModelNet](https://github.com/lobehub/lobehub) 的跨平台桌面应用程序，使用 Electron 构建，提供了更加原生的桌面体验和功能。
...
1. Fork [ModelNet 仓库](https://github.com/lobehub/lobehub)
2. 按照我们的设置指南建立桌面开发环境
3. 对桌面应用程序进行修改
