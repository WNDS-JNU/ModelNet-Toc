 ...
 * edge before forwarding to ModelNet. Advisory: the server-side routers stay
 ...
 * ModelNet's webhook. Outbound messaging is NOT routed through the gateway;
 * ModelNet calls platform REST APIs directly.
 *
