...
const EN_US: MessengerSystemStrings = {
  ...
  agentsEmpty: 'You have no agents yet. Create one in ModelNet, then come back to /agents.',
  ...
  checkDirectMessage: 'Check your DM with ModelNet for the link button.',
  ...
  modeDirectMessageOnly: 'Open your direct message with the ModelNet bot and send `/mode` there.',
  modePicker: 'Pick the conversation mode:',
  needLink: 'You need to /start to bind your account first.',
  newDirectMessageOnly: 'Open your direct message with the ModelNet bot and send `/new` there.',
  ...
  scopeSwitched: (name, agentTitle) =>
    agentTitle
      ...
      : `Switched to ${name}. No agents here yet — create one in ModelNet, then /agents.`,
  ...
  startDirectMessageOnly:
    'Open your direct message with the ModelNet bot and send `/start` there to link your account.',
  staleAgent:
  ...
  stopDirectMessageOnly: 'Open your direct message with the ModelNet bot and send `/stop` there.',
...
const ZH_CN: MessengerSystemStrings = {
  accountAlreadyLinked:
    '你的账号已绑定到 ModelNet。发送 /agents 可切换当前 Agent，发送 /new 可开启新对话。',
  ...
  agentsEmpty: '你还没有 Agent。请先在 ModelNet 创建，然后再发送 /agents。',
  ...
  checkDirectMessage: '请查看与 ModelNet 机器人的私聊消息，并点击其中的绑定按钮。',
  currentMarker: '当前',
  genericError: '发生错误，请稍后再试。',
  help: [
    '可用命令：',
    '• /start — 绑定（或重新绑定）ModelNet 账号',
    '• /switch — 切换当前空间（个人账号或工作区）',
    '• /agents — 查看 Agent 并切换当前 Agent',
    '• /new — 开启新对话',
    '• /mode — 查看或切换会话模式（agent | chat）',
    '• /stop — 停止当前执行',
    '• /feedback <内容> — 向 ModelNet 团队发送反馈（不会触发 AI 回复）',
  ].join('\n'),
  modeAgentLabel: 'Agent 模式',
  modeChangedToast: (label) => `已切换到${label}。`,
  modeChatLabel: 'Chat 模式',
  modeDirectMessageOnly: '请在与 ModelNet 机器人的私聊中发送 `/mode`。',
  modePicker: '请选择会话模式：',
  needLink: '请先发送 /start 绑定你的 ModelNet 账号。',
  newDirectMessageOnly: '请在与 ModelNet 机器人的私聊中发送 `/new`。',
...
const WECHAT_ZH_CN: MessengerSystemStrings = {
  ...
  needLink: '当前微信账号尚未连接，请前往 ModelNet 的 Messenger 设置重新扫码。',
  notLinked: '当前微信账号尚未连接，请前往 ModelNet 的 Messenger 设置重新扫码。',
};
