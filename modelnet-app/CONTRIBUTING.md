# ModelNet - Contributing Guide 🌟

We're thrilled that you want to contribute to ModelNet, the future of communication! 😄

ModelNet is an open-source project, and we welcome your collaboration. Before you jump in, let's make sure you're all set to contribute effectively and have loads of fun along the way!
...
This ensures you're working on the most current version of ModelNet. Stay fresh! 💨

## Open a Pull Request

🚀 Time to share your contribution! Head over to the original ModelNet repository and open a Pull Request (PR). Our maintainers will review your work.
...
🎈 Congratulations! Your contribution is now part of ModelNet. 🥳

Thank you for making ModelNet even more magical. We can't wait to see what you create! 🌠
