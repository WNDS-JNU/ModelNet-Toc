...
function updatePackageJson() {
  ...
  try {
    ...
    switch (releaseType) {
      case 'stable': {
        packageJson.productName = 'ModelNet';
        packageJson.name = 'lobehub-desktop';
        console.log('🌟 Setting as Stable version.');
        break;
      }
      case 'beta': {
        packageJson.productName = 'ModelNet-Beta'; // Or 'ModelNet-Beta' if preferred
      ...
      case 'nightly': {
        packageJson.productName = 'ModelNet-Nightly'; // Or 'ModelNet-Nightly'
