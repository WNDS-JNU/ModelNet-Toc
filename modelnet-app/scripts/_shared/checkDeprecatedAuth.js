...
const DEPRECATED_CHECKS = [
  {
    ...
    message: 'NextAuth has been removed from ModelNet. Please migrate to Better Auth.',
    name: 'NextAuth',
  },
  {
    ...
    message: 'Clerk has been removed from ModelNet. Please migrate to Better Auth.',
    name: 'Clerk',
  },
  {
    formatVar: (envVar) => {
  ...
  },
  {
    ...
    message:
      'ModelNet 2.0 no longer supports client-side database mode. This environment variable is now obsolete and can be removed.',
    name: 'Service Mode',
  },
  {
    getVars: () => (process.env['ACCESS_CODE'] ? ['ACCESS_CODE'] : []),
    message:
      'ACCESS_CODE is no longer supported in ModelNet 2.0. Please use Better Auth authentication system instead.',
    name: 'Access Code',
  },
  {
    getVars: () =>
  ...
  },
  {
    ...
    message:
      'Casdoor webhook is recommended for syncing user data (email, avatar, etc.) to ModelNet. This is especially important for users migrating from NextAuth to Better Auth - users without email configured in Casdoor will not be able to login. Consider configuring CASDOOR_WEBHOOK_SECRET following the documentation.',
  ...
  },
  {
    ...
    message:
      'Logto webhook is recommended for syncing user data (email, avatar, etc.) to ModelNet. This is especially important for users migrating from NextAuth to Better Auth - users without email configured in Logto will not be able to login. Consider configuring LOGTO_WEBHOOK_SIGNING_KEY following the documentation.',
    name: 'Logto Webhook',
    severity: 'warning',
  },
  {
