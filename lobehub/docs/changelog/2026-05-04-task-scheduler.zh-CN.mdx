---
title: 在 ModelNet 中调度 Claude Code 与 Codex
description: >-
  在 ModelNet 中直接调度 Claude Code 与 Codex，全新首页、批量 git diff 的 Review
  标签页、视觉理解工具，以及一批新模型。
tags:
  - 编程 Agent
  - Claude Code
...
# 在 ModelNet 中调度 Claude Code 与 Codex

![](/blog/assets71fe5959cbc6f0a89243d7262f48fafc.webp)

## 新功能

- **调度 Claude Code 与 Codex。** 在 ModelNet 内直接控制编程 Agent：新建助手时选择你的编程 Agent 即可。仅在桌面端可用。
