---
title: Using GitHub Models in ModelNet
description: >-
  Learn how to configure and use GitHub's API Key in ModelNet to start
...
# Using GitHub Models in ModelNet
...
This guide will walk you through how to use GitHub Models within ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure GitHub Models in ModelNet
...
And that’s it! You’re now ready to start using GitHub-provided models in ModelNet for conversations and interactions.
