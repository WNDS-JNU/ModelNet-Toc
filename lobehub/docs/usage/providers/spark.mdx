---
title: Using iFLYTEK Spark in ModelNet
description: >-
  Learn how to configure and use the iFLYTEK Spark API Key in ModelNet to start
...
# Using iFLYTEK Spark in ModelNet
...
This guide will walk you through how to use iFLYTEK Spark in ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure iFLYTEK Spark in ModelNet
...
That's it! You're now ready to use iFLYTEK Spark's models for conversations in ModelNet.
