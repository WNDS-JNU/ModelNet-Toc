---
title: Using SiliconCloud in ModelNet
description: >-
  Learn how to configure and use SiliconCloud's API Key in ModelNet to start
...
# Using SiliconCloud in ModelNet
...
This guide will walk you through how to use SiliconCloud within ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure SiliconCloud in ModelNet
...
That's it! You're now ready to use SiliconCloud's models for conversations in ModelNet.
