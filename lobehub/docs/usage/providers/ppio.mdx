---
title: Using PPIO API Key in ModelNet
description: >-
  Learn how to integrate PPIO's LLM API into ModelNet. Follow these steps to
  register a PPIO account, create an API key, and configure it in ModelNet.
tags:
  - PPIO
  - PPInfra
  - DeepSeek
...
# Using PPIO in ModelNet

<Image alt={'Using PPIO in ModelNet'} cover src={'/blog/assets06d4e543cbaca9a2762923a23b2cae67.webp'} />
...
This guide will walk you through how to use PPIO in ModelNet:
...
<Steps>
  ...
  ### Step 3: Configure PPIO in ModelNet
  ...
  <Image alt={'Enter PPIO API Key in ModelNet'} inStep src={'/blog/assetsbfe7d519c29884b6699e89866e1db7e2.webp'} />
...
That's it! You're now ready to use PPIO's models for conversations in ModelNet.
