...
description: Learn how to configure and use the AiHubMix provider in ModelNet
tags:
  - AiHubMix
...
AiHubMix is an AI model aggregation platform that offers access to a variety of AI models through a unified OpenAI-compatible API. This guide will help you set up the AiHubMix provider in ModelNet.
...
2. **Obtain an API Key**
   ...
   - Generate an API key for use with ModelNet
...
1. **Configure the API Key**
   ...
   - Restart your ModelNet instance

2. **Select a Model**
   - Go to ModelNet settings
