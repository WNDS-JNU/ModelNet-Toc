---
title: Using Vercel AI Gateway in ModelNet
description: Learn how to integrate and use the unified API of Vercel AI Gateway in ModelNet
tags:
  - ModelNet
  - Vercel AI Gateway
  - API Key
...
# Using Vercel AI Gateway in ModelNet
...
This guide will walk you through how to use Vercel AI Gateway within ModelNet.
...
<Steps>
  ...
  ### Step 2: Configure Vercel AI Gateway in ModelNet
...
That's it! You can now start chatting in ModelNet using models provided by Vercel AI Gateway.
