---
title: Using the Stepfun API Key in ModelNet
description: >-
  Learn how to configure and use Stepfun's AI models in ModelNet, including how
...
# Using Stepfun in ModelNet

<Image alt={'Using Stepfun in ModelNet'} cover src={'/blog/assets34400653/95717e2b-1a55-4fca-a96b-b1c186ed4563.webp'} />
...
This guide will walk you through how to use Stepfun in ModelNet:
...
<Steps>
  ...
  ### Step 2: Configure Stepfun in ModelNet
...
And that’s it! You’re now ready to start chatting with AI models powered by Stepfun in ModelNet.
