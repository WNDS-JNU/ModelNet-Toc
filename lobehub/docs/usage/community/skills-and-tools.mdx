...
<AccordionGroup>
  <Accordion title="Built-in Skills">
    Pre-installed skills that ship with ModelNet:
    ...
    Built-in skills are maintained by the ModelNet team and automatically updated.
  </Accordion>

  <Accordion title="Market Skills">
    Community-created skills available from the ModelNet marketplace:
...
ModelNet includes several powerful built-in tools:
...
Extend agent capabilities with plugins from the ModelNet marketplace:
...
MCP is ModelNet's system for connecting agents to external tools and services — databases, APIs, file systems, development tools, and business applications.
