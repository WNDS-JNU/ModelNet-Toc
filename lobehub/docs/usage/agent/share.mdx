...
Click the **Share** button in the top-right corner of the chat window to export and share your current conversation. ModelNet supports multiple formats — choose the one that fits how you want to use it.
...
- **Default** — ModelNet's standard JSON format
