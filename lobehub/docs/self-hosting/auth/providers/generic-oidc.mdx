---
title: Configuring Generic OIDC Authentication for ModelNet
description: >-
  Learn how to configure any OpenID Connect provider for ModelNet using Generic
  OIDC integration.
tags:
  - Generic OIDC
  - OpenID Connect
...
Use Generic OIDC to integrate ModelNet with any OpenID Connect compliant identity provider not explicitly listed in our supported providers.
