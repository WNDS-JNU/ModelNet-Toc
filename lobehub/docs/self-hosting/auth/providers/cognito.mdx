---
title: Configuring AWS Cognito Authentication for ModelNet
description: >-
  Learn how to configure AWS Cognito SSO for ModelNet, including creating a User
