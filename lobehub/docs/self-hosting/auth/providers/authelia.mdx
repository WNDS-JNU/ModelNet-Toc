---
title: Configuring Authelia Authentication for ModelNet
description: >-
  Learn how to configure Authelia SSO for ModelNet, including setting up OIDC
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`   | Required | SSO provider for ModelNet. Use `authelia` for Authelia                         |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authelia and use ModelNet.
</Callout>
