---
title: 在 ModelNet 中集成 Ollama
description: 学习如何在 ModelNet 中配置与部署 Ollama 语言模型框架，提升本地大模型使用体验。
tags:
  - Ollama
  - ModelNet
  - 语言模型
...
本文档将指导你如何配置与部署 ModelNet 来使用 Ollama：
...
假设你已经在本地 `11434` 端口启动了 Ollama 服务。运行以下 Docker 命令行，在本地启动 ModelNet：
...
关于在 ModelNet 中使用 Ollama 的更多信息，请查阅 [Ollama 使用](/zh/docs/usage/providers/ollama)。
