...
description: >-
  Learn how to import and export configuration settings for ModelNet via URL.
...
ModelNet support import settings from external URL to quickly set up ModelNet configuration.
...
<Callout type={'warning'}>
  ModelNet does not verify the correctness of the settings parameters in the URL, nor provide
