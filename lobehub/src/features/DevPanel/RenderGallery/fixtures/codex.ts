    ...
    web_search: single({
      args: {
        ...
        results: [
          ...
          {
            snippet: 'How ModelNet maps builtin tool inspectors, renders, and display controls.',
            title: 'ModelNet builtin tool render registry',
            url: 'https://example.com/lobehub-tools',
          },
        ],
      },
      content:
        'Search results\n\n1. Codex tool render examples - https://example.com/codex-render\n2. ModelNet builtin tool render registry - https://example.com/lobehub-tools',
    }),
  },
});
