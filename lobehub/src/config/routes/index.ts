...
export const NAVIGATION_ROUTES: NavigationRoute[] = [
  ...
  {
    cmdkKey: 'cmdk.leaderboard',
    electronKey: 'navigation.leaderboard',
    icon: Trophy,
    id: 'leaderboard',
    keywords: ['leaderboard', 'benchmark', 'modelnet', 'opencompass', 'rank'],
    keywordsKey: 'cmdk.keywords.leaderboard',
    path: '/leaderboard',
...
export const getNavigableRoutes = (): NavigationRoute[] =>
  NAVIGATION_ROUTES.filter((r) =>
    ['community', 'video', 'image', 'resource', 'page', 'leaderboard', 'memory'].includes(r.id),
  );
