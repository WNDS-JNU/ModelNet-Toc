...
export const FLUX_MODEL_CONFIG = {
  FILENAME_PREFIXES: {
    DEV: 'ModelNet/%year%-%month%-%day%/FLUX_Dev',
    KONTEXT: 'ModelNet/%year%-%month%-%day%/FLUX_Kontext',
    KREA: 'ModelNet/%year%-%month%-%day%/FLUX_Krea',
    SCHNELL: 'ModelNet/%year%-%month%-%day%/FLUX_Schnell',
  },
} as const;
...
export const SD_MODEL_CONFIG = {
  FILENAME_PREFIXES: {
    CUSTOM: 'ModelNet/%year%-%month%-%day%/CustomSD',
    SD15: 'ModelNet/%year%-%month%-%day%/SD15',
    SD35: 'ModelNet/%year%-%month%-%day%/SD35',
    SDXL: 'ModelNet/%year%-%month%-%day%/SDXL',
  },
} as const;
