...
describe('Protocol', () => {
  describe('generateRFCProtocolUrl', () => {
    it('should generate valid RFC protocol URL for stdio type', () => {
      ...
      expect(url).toMatch(/^modelnet:\/\/plugin\/install\?/);
  ...
  describe('URL encoding/decoding', () => {
    ...
    it('should handle different protocol schemes', () => {
      const testCases = [
        'modelnet://plugin/install?test=value',
        'modelnet-dev://plugin/install?test=value',
        'modelnet-beta://plugin/install?test=value',
        'modelnet-nightly://plugin/install?test=value',
