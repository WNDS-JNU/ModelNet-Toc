---
name: cli
description: ModelNet CLI (@lobehub/cli) development guide — commands, subcommands, architecture.
disable-model-invocation: true
---

# ModelNet CLI Development Guide

## Overview

ModelNet CLI (`@lobehub/cli`) is a command-line tool for managing and interacting with ModelNet services. Built with Commander.js + TypeScript.
